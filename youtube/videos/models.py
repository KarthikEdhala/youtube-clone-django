...
from .imagekit_client import add_image_watermark, get_optimized_video_url, get_streaming_url, get_thumbnail_url
...
class VideoLike(models.Model):
    ...
    def __str__(self):
        return f"{self.user.username} {self.value} {self.video.title}"